    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div class="flex flex-wrap justify-center gap-4 sm:gap-8">
                <a href="{{ url('/') }}#home" class="text-villa-cream/60 hover:text-villa-gold text-xs sm:text-sm tracking-wider uppercase transition-colors">Início</a>
                ...
                <a href="{{ url('/') }}#reservas" class="text-villa-cream/60 hover:text-villa-gold text-xs sm:text-sm tracking-wider uppercase transition-colors">Reservas</a>
                <a href="{{ url('/') }}#contact" class="text-villa-cream/60 hover:text-villa-gold text-xs sm:text-sm tracking-wider uppercase transition-colors">Contato</a>
            </div>
