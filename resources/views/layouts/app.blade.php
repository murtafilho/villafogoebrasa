...
<head>
    ...
    @php
        $defaultTitle = 'Villa Fogo & Brasa - Churrascaria Premium em Nova Lima';
        $defaultDescription = 'Autêntico churrasco gaúcho com cortes nobres e ambiente sofisticado. Reserve sua mesa e viva uma experiência gastronômica única em Nova Lima!';
        if (!isset($ogTitle)) {
